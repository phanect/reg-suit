...
- [reg-publish-cloudflare-pages-plugin](https://github.com/reg-viz/reg-suit/tree/master/packages/reg-publish-r2-plugin/README.md) - _publisher plugin_ - An alternative publisher plugin. It's so similar to S3 plugin but this uses Cloudflare R2 instead of S3.
